...
<!--                <img src="--><?//= Url::to(['../frontend/web/images/logo.png'])?><!--" alt="Homepage">-->
                <div class="s-intro__content-bottom">
                    <h1 class="s-intro__content-title">CURA BEAUTY</h1>
                </div>
            </a>
        </div>
...
<!--            </li>-->
            <li>
                <a href="https://www.instagram.com/curabeauty.shop/?hl=en">
    ...
    <div class="row s-footer__bottom">
        <div class="column lg-12">
            <div class="ss-copyright">
                <span>© Copyright GT 2022</span>
                <span>Design by <a href="">GT</a></span>
            </div>
        </div>
