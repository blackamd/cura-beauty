        ...
        <section id="intro" class="s-intro">
            <div class="s-intro__slider swiper-container">
                <div class="swiper-wrapper">
                    <div class="s-intro__slide swiper-slide bg-opacity-10" style="background-image: url('../web/images/slides/slide-04.jpg');"></div>
                    <div class="s-intro__slide swiper-slide bg-opacity-40" style="background-image: url('../web/images/slides/slide-05.jpg');"></div>
                    <div class="s-intro__slide swiper-slide bg-opacity-40" style="background-image: url('../web/images/slides/slide-06.jpg');"></div>
                    <div class="s-intro__slide swiper-slide bg-opacity-40" style="background-image: url('../web/images/slides/slide-07.jpg');"></div>
                    <div class="s-intro__slide swiper-slide bg-opacity-40" style="background-image: url('../web/images/slides/slide-08.jpg');"></div>
                    <div class="s-intro__slide swiper-slide bg-opacity-40" style="background-image: url('../web/images/slides/slide-09.jpg');"></div>
                    <div class="s-intro__slide swiper-slide bg-opacity-40" style="background-image: url('../web/images/slides/slide-10.jpg');"></div>
                    <div class="s-intro__slide swiper-slide bg-opacity-40" style="background-image: url('../web/images/slides/slide-11.jpg');"></div>
                </div>
            </div>
            ...
            <div class="row s-intro__content">
                <div class="column lg-12">
                    ...
                    <div class="s-intro__content-bottom">
                        <h1 class="s-intro__content-title">Cura Beauty App is launching soon.</h1>
                        <p>
                            Cura Beauty App is a modern and stylish APP <br>
                            Who is created for you to experience the <br>
                            Excitement and the unique beauty of its kind.
                        </p>
                    </div>
