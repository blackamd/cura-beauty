...
<head>
<meta charset="utf-8">
<title>BlackFit HTML-5 Template | Shoping Cart</title>
<!-- Stylesheets -->
        	...
        	<div class="outer-container">
            	<div class="inner-container clearfix">
					...
					<div class="outer-box clearfix">
						...
						<div class="cart-box">
							<div class="dropdown">
								<button class="cart-box-btn dropdown-toggle" type="button" id="dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="cart-icon"><img src="images/icons/bag.svg" alt="" /></span><span class="total-cart">2</span></button>
								<div class="dropdown-menu pull-right cart-panel">

									<div class="cart-product">
										<div class="inner">
											<div class="cross-icon"><span class="icon flaticon-multiply"></span></div>
											<div class="image"><img src="https://via.placeholder.com/130x155" alt="" /></div>
											<h3><a href="shop-single.html">Running <br> Lassina</a></h3>
									...
									<div class="cart-product">
										<div class="inner">
											<div class="cross-icon"><span class="icon flaticon-multiply"></span></div>
											<div class="image"><img src="https://via.placeholder.com/130x155" alt="" /></div>
											<h3><a href="shop-single.html">Running <br> Snikers</a></h3>
											<div class="price">$99.00</div>
										</div>
									</div>
									<div class="cart-total">Sub Total: <span>$198.90</span></div>
									<a href="checkout.html" class="theme-btn btn-style-one"><span class="txt">Checkout</span></a>
								</div>
							</div>
						</div>
            ...
            <div class="cart-outer">
                            ...
                            <tr>
                                <td class="prod-column">
                                    <div class="column-box">
                                        <figure class="prod-thumb"><a href="#"><img src="https://via.placeholder.com/93x112" alt=""></a></figure>
                                ...
                                <td class="remove"><a href="#" class="remove-btn"><span class="flaticon-multiply"></span></a></td>
                            </tr>
                ...
                <div class="coupon-outer clearfix">
                    <div class="pull-left">
                        <div class="apply-coupon clearfix">
                            ...
                            <div class="form-group clearfix">
                                <button type="button" class="theme-btn coupon-btn btn-style-one"><span class="txt">Apply Coupon</span></button>
                            </div>
                        </div>
                    </div>
                    
                    <div class="pull-right">
                        <button type="button" class="theme-btn btn-style-one cart-btn"><span class="txt">Update Cart</span></button>
                    </div>
                ...
                <div class="cart-total-box">
                    ...
                    <ul class="totals-table">
                        <li class="clearfix"><span class="col col-title">Subtotal</span><span class="col">$96.90</span></li>
                        <li class="clearfix"><span class="col col-title">Tax</span><span class="col">$96.90</span></li>
                        <li class="total clearfix"><span class="col col-title">Total .</span><span class="col">$193.2</span></li>
                    </ul>
                </div>
                <div class="text-left"><button type="submit" class="theme-btn btn-style-one checkout-btn"><span class="txt">Proceed to Checkout</span></button></div>
            </div>
