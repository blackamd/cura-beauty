...
<head>
<meta charset="utf-8">
<title>BlackFit HTML-5 Template | Trainer 01</title>
<!-- Stylesheets -->
						...
						<nav class="main-menu navbar-expand-md">
							...
							<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
								<ul class="navigation clearfix">
									...
									<li class="current dropdown"><a href="#">Trainers</a>
										<ul>
    ...
    <div class="sidebar-page-container">
    	<div class="auto-container">
        	<div class="row clearfix">
				...
				<!-- Content Side -->
                <div class="content-side trainer-content col-lg-9 col-md-12 col-sm-12">
                	<div class="trainer-detail">
						<div class="inner-box">
							<div class="row clearfix">
								...
								<div class="column col-lg-6 col-md-6 col-sm-12">
									...
									<p>Dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum.</p>
								</div>
								<!-- Column -->
								<div class="column col-lg-6 col-md-6 col-sm-12">
									<div class="image">
							...
							<div class="blockquote">
								Want to be healthy and have a perfect body? BigBear is the right decision for you! It will create your personal training program and balance your diet so you could get the shape of your dream shortly!
							</div>
							...
							<div class="post-share-options clearfix">
								<ul class="social-box">
									...
									<li><a href="https://www.facebook.com/readyfightsystem"><span class="fa fa-facebook-f"></span></a></li>
									<li><a href="#"><span class="fa fa-twitter"></span></a></li>
									<li><a href="https://instagram.com/readyfightsystemegypt?r=nametag"><span class="fa fa-instagram"></span></a></li>
						...
						<div class="comment-form">
							...
							<div class="form-text">If you need of a Personal Trainer, Fitness Instructor advice, or a healthy living product review, <br> please feel free to contact us</div>
							<!--Comment Form-->
