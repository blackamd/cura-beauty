...
<head>
<meta charset="utf-8">
<title>BlackFit HTML-5 Template | Checkout</title>
<!-- Stylesheets -->
                        		...
                        		<div class="billing-inner">
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <input type="text" name="field-name" value="" placeholder="House number and streen name">
                                            <input class="address-two" type="text" name="field-name" value="" placeholder="Apartment, suite, unite etc (optional)">
                                        </div>
									...
									<div class="checkout-order-box">
										...
										<button type="button" class="theme-btn btn-style-one"><span class="txt">Place Order</span></button>
									</div>
										...
										<div class="coupon-form">
											<form method="post" action="contact.html">
												<div class="form-group">
													<input type="email" name="email" value="" placeholder="Coupon code" required>
													<button type="button" class="theme-btn btn-style-one"><span class="txt">APPLY COUPON</span></button>
												</div>
											</form>
										</div>
